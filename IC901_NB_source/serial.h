...
#define	getchrQ()		getchr0()
#define	gotchrQ()		gotchr0()
#define	gotmsgQ()		gotmsg0()
#define	gotmsgnQ()		gotmsgn0()
#define	getsQ(x)		gets0(x)
#define	getssQ(x)		getss0(x)
#define	putsQ(x)		puts0(x)
#define	putssQ(x)		putss0(x)
#define	getchQ()		getchr0()
#define	putcharQ(x)		putchar0(x)
...
#define	set_baudQ(x)	set_baud0(x)
