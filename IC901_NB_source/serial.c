...
//	UART1_CC_R = UART_CC_CS_PIOSC;					// set PIOSC as UART source
	UART1_CC_R &= UART_CC_CS_M;							// set SYSCLK as UART source
	UART1_CC_R |= UART_CC_CS_SYSCLK;					// set SYSCLK as UART source
